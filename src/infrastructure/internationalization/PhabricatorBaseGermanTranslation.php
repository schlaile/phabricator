...
abstract class PhabricatorBaseGermanTranslation
  ...
  public function getTranslations() {
    return array(
      ...
      'file(s)' => array('Datei', 'Dateien'),
      'Maniphest Task(s)' => array('Maniphest Aufgabe', 'Maniphest Aufgaben'),
      'Task(s)' => array('Aufgabe', 'Aufgaben'),

      'Please fix these errors and try again.' => array(
        'Bitte diesen Fehler korrigieren und nochmals probieren.',
        'Bitte diese Fehler korrigieren und nochmals probieren.',
      ),

      '%d Error(s)' => array('%d Fehler', '%d Fehler'),
